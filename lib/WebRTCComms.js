...
function WebRTCComms(rtc, shuffleStateFactory, logger) {
    ...
    this.sendShuffleRequest = function (fromNode, destinationNodePointer, shuffleSet) {
        ...
        var outgoingState = shuffleStateFactory.createOutgoingShuffleState(fromNode, destinationNodePointer, shuffleSet);

        currentOutgoingShuffle = rtc.openChannel("cyclonShuffle", destinationNodePointer)

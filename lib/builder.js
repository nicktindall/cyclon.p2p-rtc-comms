...
function WebRTCCyclonNodeBuilder (logger, metadataProviders, signallingServers, storage) {
...
module.exports.create = function(logger, metadataProviders, signallingServers, storage) {
	return new WebRTCCyclonNodeBuilder(logger, metadataProviders, signallingServers, storage);
};
